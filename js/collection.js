  ...
  projects: [
    ...
    */
    ...
    },
    {
      ...
      "Long Description of your work (4-6 sentences).":
        "- Facial Motion Capture... in Your Browser. Phiz's motion capture system was built using Mocap4face and Google mediapipe's machine learning model. No iPhone LiDAR or RGBD camera needed! The underlying ML code is not fixed and will be updated whenever there is a better model. — Streaming Data: Unreal and Unity Support. Phiz includes custom plugins that fire up WebSocket servers within Unreal Engine and Unity, which are used to receive live data from your browser. The plugins also include convenient presets that you can easily use with popular 3D avatars, such as Metahumans and ReadyPlayerMe characters. - Streaming Data: Browser to Browser & Browser to OSC App. Phiz uses WebRTC (the protocol used in video calling) to send data from one browser to another or from a browser to the app. However, no image or video is sent at all. WebRTC also allows for peer-to-peer secure connection and low latency. - ARKit Support. Phiz uses the same blendshapes as ARKit. Check out the Blendshapes page for more information about the blendshape names and orders.",
    ...
    */
    ...
    },
    {
      ...
      "Long Description of your work (4-6 sentences).":
        "In New York City, as flooding becomes a greater issue exacerbated by climate change, flood data becomes crucial. The deployment of FloodNet sensors provides the ability to collect, live track, and uncover flood patterns and events. This data provides insight into flood risk, and damage, which can lead to potential solutions. In this thesis we question whom this data is designed for, does it generate public engagement, do people have the informational resources they need, and how can various forms of the data garner a greater connection between the data and the people it represents.",
    ...
    },
    {
      ...
      'If you selected "Other", please write your description below:': "",
      "Short project description (one sentence - 500 characters)":
        "A cyborg is trapped in the world of her own anxiety, and meets her nature double in a illusory dream where parallel world has overlapped. This is an art-based research project, it uses 3D moving images to enrich modern interpretations of Taoist culture and provide a reference for the industry of 3D works on the theme of Eastern philosophical culture.",
      "Long Description of your work (4-6 sentences).":
        "This project is inspired by Zhuangzi's classic fable, The Butterfly Dream, and was recreated by Ruiyang Dai’s individual experience. This 3D experimental video by depicting a person’s emotional journey, from anxiety, hysteria to relief, aims to inspire people to have a close connection with their natural self, which is a condition when you go with the flow, transcend the differences and regulations, see the essence of things. Thus, a state of high mental freedom is achieved and over-anxiety is avoided.",
